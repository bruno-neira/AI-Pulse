...
## Are User Growth and Inference Costs Rising Together?
...
### How Closely Are New Models Tied to New Compute Infrastructure?
...
### Do Companies Build Clusters Before Models or Models Before Clusters?
...
### Is Everyone Scaling Compute at the Same Pace?
...
### How does OpenAI rank in cluster cost? Is the public sector keeping up?
...
OpenAI is actually trailing behind MetaAi and xAI in ~$3b and ~$6b respectively despite being the center of much of our analysis.
- Anthropic does not make the cut into the top 10, or even top 20 when peering at previous iterations of the graph. Still, comparing a company’s cluster costs to how well-known or widely used their llm is, this does not indicate that Anthropic is an overachiever anymore than it indicates that xAI or MetaAi are underachievers.
- Almost every cluster owner in the public sector was outcompeted by owners in the private sector except for the US Department of Energy. The DOE also spent around $1-1.5b more than OpenAI.
- Companies that were under the label of private/public had the least calculated costs in GPU clusters.
...
### Are Datasets Growing Faster Because of New Model Architectures?
...
## Is Compute Supply Finally Catching Up With Model Demands?
...
## What Factors Explain Most of the Variation in Benchmark Performance?
...
## Which Countries Are Becoming the Global Centers of Compute?
